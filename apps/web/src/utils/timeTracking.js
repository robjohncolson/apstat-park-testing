 ...
 */
export function calculatePaceMetrics(completedLessons, totalLessons, examDate = getDefaultExamDate(), now = new Date(), currentBufferHours = 0, // TODO Phase 6: Load from persistence
lastDeadline) {
    ...
    let nextDeadline = new Date(now); // Default fallback
    ...
    if (daysUntilExam > 0) {
        ...
        if (lessonsRemaining > 0) {
            ...
            if (lastDeadline) {
                ...
                nextDeadline = new Date(now.getTime() +
 ...
 */
export function formatPaceStatus(metrics) {
 ...
 */
export function formatBufferStatus(metrics) {
 ...
 */
export function formatTargetPace(targetLessonsPerDay) {
 ...
 */
export function formatTimeRemaining(metrics) {
 ...
 */
export function getEncouragementMessage(completionRatio) {
